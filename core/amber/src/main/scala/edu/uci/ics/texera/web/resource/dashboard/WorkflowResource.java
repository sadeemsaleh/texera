...
import edu.uci.ics.texera.workflow.jooq.generated.tables.daos.WorkflowDao;
import edu.uci.ics.texera.workflow.jooq.generated.tables.daos.WorkflowOfUserDao;
import edu.uci.ics.texera.workflow.jooq.generated.tables.pojos.Workflow;
import edu.uci.ics.texera.workflow.jooq.generated.tables.pojos.WorkflowOfUser;
...
import static edu.uci.ics.texera.workflow.jooq.generated.Tables.WORKFLOW;
import static edu.uci.ics.texera.workflow.jooq.generated.Tables.WORKFLOW_OF_USER;
...
public class WorkflowResource {
    ...
    public List<Workflow> getUserWorkflow(@Session HttpSession session) {
        ...
        return getWorkflowsByUser(user.getUserID());
    }
     ...
     * @return Workflow
     */
    private List<Workflow> getWorkflowsByUser(UInteger userId) {
     ...
     * @return Workflow
     */
    private Workflow insertWorkflowToDataBase(String name, String content) {
