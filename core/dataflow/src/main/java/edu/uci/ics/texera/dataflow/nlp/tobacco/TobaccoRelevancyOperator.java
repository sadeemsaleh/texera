...
public class TobaccoRelevancyOperator implements IOperator {
    ...
    private final static String PYTHONSCRIPT = Utils.getResourcePath("tobacco_relevancy_classify.py", TexeraProject.TEXERA_DATAFLOW).toString();
    ...
    public void open() throws TexeraException {
        ...
        try {
            ...
            List<String> args = new ArrayList<>(
                    Arrays.asList(
                            PYTHON, PYTHONSCRIPT,
                            Integer.toString(portNumber), VectorizerPath, ClassifierPath,
